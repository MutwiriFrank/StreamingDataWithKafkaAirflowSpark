...
# create keyspace. is equivalent to schema in rdmbms
...
def create_spark_connection():
    ...
    try:
        ...
        print("Spark connection not created -------------------------------------------------------------")
...
def create_cassandra_conection():
    # connectin to cassandra cluster
    ...
    try:
        ...
        logging.error(f"Could not find a connection due to {e}")
        return None
